...
func registerAppFlags(fs *flag.FlagSet, cfg *appConfig) {
	...
	utils.IntFlagEnv(fs, &cfg.Relay.Cache.PopulationConcurrency, "cache-population-concurrency", 2, nil, "maximum concurrent cache operations; busy caches fall back to origin", "CACHE_POPULATION_CONCURRENCY")
