...
- **No Accounts, No API Keys** — Authentication uses Sui personal-message signatures with a locally generated Ed25519 key pair. No email, no registration, no vendor lock-in.

- **Sui Payments** — Turn APIs, content, and local web apps into Sui USDC paid endpoints without a centralized billing gateway.
...
# Require Sui USDC payment before a local HTTP upstream receives traffic
